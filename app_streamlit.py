...
4. ⌨️ Preencha os campos padrão como horário de retorno, plataforma e responsável espiritual do ônibus
5. ⚙️ Clique em **"Gerar Crachás"** para baixar o PDF pronto para impressão

---
ℹ️ Dica: os campos em branco na planilha serão deixados vazios no crachá. Revise os dados, pois nomes muito grandes podem sair do espaço padrão. A seleção dos "Possui convênio médico?" e "Tipo do contato" precisam ser selecionados manualmente por enquanto.
""")
